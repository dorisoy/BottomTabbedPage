...
namespace Naxam.Demo
{
    public partial class App : Application
    {
        public App()
        {
			...
			{
				Title = "Tab 1",
                IconImageSource = icons.FirstOrDefault() ?? "ic_audiotrack_black_24dp",
			...
			{
				Title = "Tab 2",
                IconImageSource = icons.Skip(1).FirstOrDefault() ?? "ic_backup_black_24dp",
			...
			{
				Title = "Tab 3",
                IconImageSource = icons.Skip(2).FirstOrDefault() ?? "ic_camera_black_24dp",
			...
			{
				Title = "Tab 4",
                IconImageSource = icons.Skip(3).FirstOrDefault() ?? "ic_favorite_black_24dp",
